  ...
  <body class="bg-dark text-white">
    ...
    <div class="container py-4">
      ...
      <div class="mb-4 d-flex justify-content-between align-items-center">
        ...
        <button class="btn netflix-btn" id="toggleFilter">
      ...
      <div class="movie-row d-flex flex-nowrap overflow-auto gap-3 pb-3">
        ...
        <div class="movie-card bg-dark border-0 text-center">
          <div class="position-relative" style="width: 160px">
            <img
              src="https://product.hstatic.net/1000376556/product/chu_thuat_hoi_chien_-_tap_6_-_hop_qua_tang_1ea2620e6bb5416c9f1f994ed4e4913e_1024x1024.jpg"
              class="card-img-top"
              alt="Tên phim"
            />
            <span
