<%-- 
    Document   : performersInfo
    Created on : Oct 3, 2025, 12:55:52 PM
...
<html lang="vi">
  <head>
    ...
    <link href="../css/actorinformation.css" rel="stylesheet" type="text/css"/>
  </head>
      ...
      <div class="row justify-content-center align-items-start">
        ...
        <div class="col-md-4 mt-5">
          ...
          <div class="actor-details mt-4 text-start">
              <h3 class="text-white">Tom Holland</h3> <!-- name -->
            <p>
                <strong>Giới thiệu:</strong> Thomas Stanley Holland (born 1 June <!-- Description -->
            ...
            <p><strong>Giới tính:</strong> Nam</p> <!-- gender -->
            <p><strong>Ngày sinh:</strong> 01/06/1996</p> <!-- dateofbirth -->
          </div>
        </div>

        <!-- Bên phải -->
        <div class="col-md-8 mt-4 mt-md-0">
          <h3 class="mb-4 text-white">Các phim đã tham gia</h3>
