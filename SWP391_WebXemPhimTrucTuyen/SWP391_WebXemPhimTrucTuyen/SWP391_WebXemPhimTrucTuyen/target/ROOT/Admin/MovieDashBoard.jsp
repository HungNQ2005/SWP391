        ...
        <div class="content">
                    ...
                    <div class="modal-content bg-dark text-white">
                        ...
                        <div class="modal-body">
                            ...
                            <c:if test="${not empty error}">
                                <div class="alert alert-danger" role="alert" id="serverErrorAlert">
                                    ${error}
                                </div>
                            </c:if>
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function () {
                    // Tìm xem có thông báo lỗi từ server không
                    const serverErrorAlert = document.getElementById("serverErrorAlert");

                    if (serverErrorAlert) {
                        // Nếu có, tự động mở modal "Add Movie" để người dùng thấy lỗi
