    ...
    <body>
        ...
        <script>
            ...
            if (editForm) {
                ...
                const addPassword = document.getElementById('editPassword');
                ...
                editForm.addEventListener("submit", function (e) {
                    ...
                    if (!checkEmail(editEmail))
                        isValid = false;
                    if (addPassword.value.trim().length > 0 && addPassword.value.length < 6) {
                    ...
                    data.append("password", addPassword.value.trim()); 
                    fetch("account", {
                        method: "POST",
                        body: data,
                        headers: {
