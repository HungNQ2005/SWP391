        ...
        <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <div style="color: red; padding: 10px; border: 1px solid red; background: #ffebeb; margin-bottom: 15px;">
                        ${sessionScope.errorMessage}
                    </div>
                    <c:remove var="errorMessage" scope="session" /> <%-- Xóa thông báo sau khi hiển thị --%>
                </c:if>
                <c:if test="${not empty sessionScope.successMessage}">
                    <div style="color: green; padding: 10px; border: 1px solid green; background: #e6ffec; margin-bottom: 15px;">
                ...
                <c:forEach var="c" items="${listCountry}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="country?action=delete&id=${c.country_id}"
