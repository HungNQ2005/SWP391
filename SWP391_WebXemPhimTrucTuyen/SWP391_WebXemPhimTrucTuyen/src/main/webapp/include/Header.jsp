            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-5">
                    ...
                    <li class="nav-item ms-3">
                        <a class="btn btn-warning text-dark fw-semibold" href="${pageContext.request.contextPath}/upgrade/activation.jsp">
                            Redeem CD Key
                        </a>
                    </li>
                ...
                <c:otherwise>
                    ...
                    <div class="dropdown d-flex align-items-center">
                        ...
                        <c:if test="${sessionScope.guest.user_level eq 'Admin'}">
                            <a href="${pageContext.request.contextPath}/admin/account?action=sendAccountDashboard"
