...
<head>
    <meta charset="UTF-8"/>
    <title>The Conjuring: Nghi L? Cu?i C�ng</title>
    <link
...
<div class="col-12 mt-5">
    ...
    <div>
        <div class="Actor d-flex justify-content-around">
            <a href="#"><img src="Images/Banner1.jpg" alt="Di?n vi�n 1"/></a>
            <a href="#"><img src="Images/Banner2.jpg" alt="Di?n vi�n 2"/></a>
            <a href="#"><img src="Images/Banner3.jpg" alt="Di?n vi�n 3"/></a>
            <a href="#"><img src="Images/Banner1.jpg" alt="Di?n vi�n 4"/></a>
        </div>
    </div>
</div>
</body>
